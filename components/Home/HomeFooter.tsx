...
export const HomeFooter = () => {
  return (
    <footer className="flex-col rounded-lg p-4 shadow dark:bg-gray-800 md:flex md:items-center md:justify-between md:p-6">
      <div className="w-full flex-row flex-wrap justify-between border-t-[1px] border-neutral-800 py-10 md:flex md:justify-between md:px-10">
        ...
        <div className="mt-10 items-center md:mt-0 md:flex">
          ...
          <div className="mx-4 mb-10 md:flex">
      ...
      <div className="md:flex ">
        <div className="mb-5 flex flex-row items-center justify-center space-x-10 text-xs font-medium text-neutral-500	">
          &copy; 2022 DIASPORA
        </div>
      </div>
    </footer>
