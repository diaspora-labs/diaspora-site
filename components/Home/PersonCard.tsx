...
export const PersonCard = (props: Props) => {
  ...
  return (
    <div className="md:w-full">
      <div
        onClick={onClick}
        className="cursor-pointer group relative mb-10 flex flex-col items-center rounded-[2.5rem] border border-[#2D2A26] transition ease-in-out hover:border-green-hover lg:flex-row"
      >
