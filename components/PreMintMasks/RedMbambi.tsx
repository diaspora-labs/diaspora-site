...
function setupLights(scene3) {
  ...
  scene3.add(light4s);
  var light2a3 = new THREE.DirectionalLight(0xffffff, 2.5);
  light2a3.position.set(2, 0, 2);
  scene3.add(light2a3);
  var light23 = new THREE.DirectionalLight(0xffffff, 2.5);
  light23.position.set(-2, 0, 2);
  scene3.add(light23);
  var light333 = new THREE.DirectionalLight(0xffffff, 2.5);
  light333.position.set(0, 0, -1);
  scene3.add(light333);
  var light43 = new THREE.DirectionalLight(0xffffff, 1);
  light43.position.set(0, 0, 2);
  scene3.add(light43);
