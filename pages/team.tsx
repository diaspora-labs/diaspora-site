  ...
  return (
    <Layout>
      <div className="lg:mt-40 mt-20">
        ...
        {props.showModal &&
          (<div  id="defaultModal" aria-hidden="true" className={`backdrop-blur-lg absolute top-[100px] md:top-[150px]  inset-x-0 mt-50 flex flex-col items-center overflow-y-auto overflow-x-hidden z-50 w-full md:inset-x-0 h-modal md:h-full`}>
