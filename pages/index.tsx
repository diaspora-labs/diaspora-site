...
const Home: NextPage = () => {
  ...
  const social = {
    ...
    linkedIn: {
      name: "LinkedIn",
      icon: (props: any) => (
        <svg fill="#000000" viewBox="0 0 30 30" {...props}>
    ...
    foundation: {
      name: "Foundation",
      icon: (props: any) => (
        <svg width="55" fill="#000000" viewBox="0 0 100 30">
          <path
            fillRule="evenodd"
  ...
  return (
    <Layout showLogo>
      ...
      <section className={showModal ? "md:hidden" : "pointer-events-auto z-10 flex h-full min-h-screen flex-col border-t-[1px] border-neutral-800"}>
        <div className="flex grow flex-col p-10">
          ...
          <Team showModal={showModal} setShowModal={setShowModal} people={people} setSelectedIndex={setSelectedIndex} />
        </div>
      </section>
