    ...
    const ntfs = [
        {
          ...
          modalDescription: "Amidst the bustling virtual marketplace, the Cote mask stands as a symbol of unity and support. The unlimited mintability of AR passes invites supporters of all backgrounds and inclinations to join the ranks of the DAO. The Cote tier encompasses the vibrant community that gravitates towards the essence of Diaspora DAO. These dedicated supporters, while unsure of their minting journey, remain close to the action, participating in general channels and embracing the spirit of collaboration. With open hearts and a shared passion for Web 3 and NFT art, the Cote supporters add their unique voice to the collective narrative, fostering an inclusive and dynamic ecosystem.",
          cost: 2,
        ...
        },
        {
          ...
          modalDescription: "Deep in the heart of the virtual forest, a mystical creature known as the Red Mbambi roams. Its vibrant crimson hue symbolizes the passion and dedication of the DAO Contributors, who play a vital role in shaping the destiny of Diaspora DAO. With only 333 AR passes available, this exclusive tier represents the bridge between technical and non-technical supporters, offering a coveted guarantee to mint an Ancestor from the collection. Beyond the NFT realm, these contributors lend their expertise to product development, community moderation, and more, weaving their skills into the very fabric of the DAO's evolution. The Red Mbambi serves as a rallying emblem, reminding us of the power of collaboration and the transformative impact we can achieve together.",
          cost: 6,
